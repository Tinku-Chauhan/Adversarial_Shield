...
| Loss function | Cross-entropy | **Cosine similarity + MSE toward antipodal** |
...
InceptionResnetV1 ──► 512-d embedding vector  [your identity, L2-normalised]
   ...
   │  [minimise both terms = push embedding away from original identity]
...
| 0.02 | PSNR ~44 dB, invisible | Moderate | **Default** |
| 0.05 | PSNR ~42 dB, invisible | Strong | High-risk photos |
| 0.10 | PSNR ~36 dB, barely visible | Very strong | Max protection |
...
✅ **Demonstrated:** Cosine similarity drops below 0.5 at ε ≥ 0.05 (identity cloaked)
✅ **Demonstrated:** 5/5 surrogate models disrupted (FaceNet VGGFace2, CASIA-WebFace, ResNet50, ResNet101, MobileNetV3)
✅ **Demonstrated:** PSNR >40 dB at ε=0.05 — noise is imperceptible to human vision
⚠️ **Partial:** Transfer to black-box commercial APIs (Clearview, AWS Rekognition) not guaranteed
